        ...
        switch ($tipo) {
            ...
            case "ticket_finalizado_usuario":
                ...
                break;
                         ...
                         case "ticket_finalizado_orquestador":
                $asunto = "El ticket ha sido finalizado";
                $para = $datos['correo'];
                $html = plantillaCorreo(
                    "Ticket finalizado",
                    "<p>Hola,<br>
                    El responsable {$datos['nombre']} ha marcado el ticket <b>{$datos['titulo']}</b> como <b>Finalizado</b>.<br>
                    Gracias por usar la Mesa de Ayuda RANSA.</p>"
                );
                break;
            ...
            case "reset_password":
                ...
                break;
            case "ticket_reasignado_usuario":
                $asunto = "Tu ticket ha sido reasignado";
                $para = $datos['correo'];
                $html = plantillaCorreo(
                    "Ticket reasignado",
                    "<p>Hola <b>{$datos['nombre']}</b>,<br>
                    Tu ticket <b>{$datos['titulo']}</b> ha sido reasignado a <b>{$datos['nuevo_responsable']}</b>.<br>
                    El equipo de soporte atenderá tu solicitud pronto.</p>"
                );
                break;
            case "confirm_email":
